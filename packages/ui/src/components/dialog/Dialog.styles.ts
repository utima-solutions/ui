...
export const dialogDef = twOverrides(
  {
    ...
    content: {
      ...
      close: `${globalDef.ring} transition-all absolute right-4 top-4 rounded-sm hover:text-muted-fg/80 focus:outline-none disabled:pointer-events-none data-[state=open]:text-muted-fg`,
      closeIcon: 'h-4 w-4',
    },
  },
  'dialog',
