...
export const badgeDef = twOverrides(
  {
    badge: 'border rounded-radius font-semibold inline transition-all h-auto',
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: 'px-1.5 text-xs py-0.5',
        md: 'px-2 text-xs py-1',
        lg: 'px-3 text-sm py-1.5',
        xl: 'px-3 text-base py-1.5',
      },
      outline: {
